 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Wed Oct 23 09:12:47 2024
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                sfcn_toPins
...
/* Input Port  2 */
#define IN_PORT_2_NAME                 torqueOut
...
/* Output Port  0 */
#define OUT_PORT_0_NAME                EnableOut
...
extern void sfcn_toPins_Outputs_wrapper(const real_T *Enable,
  const real_T *Analog,
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port Enable of S-Function sfcn_toPins");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port Analog of S-Function sfcn_toPins");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port torqueOut of S-Function sfcn_toPins");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port Mode of S-Function sfcn_toPins");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port cartPos of S-Function sfcn_toPins");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port Input of S-Function sfcn_toPins");
      return;
    }
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port EnableOut of S-Function sfcn_toPins");
      return;
    }
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port Dir of S-Function sfcn_toPins");
      return;
    }
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port PWMOut of S-Function sfcn_toPins");
      return;
    }
...
{
  const real_T *Enable = (real_T *) ssGetInputPortRealSignal(S, 0);
  const real_T *Analog = (real_T *) ssGetInputPortRealSignal(S, 1);
  const real_T *torqueOut = (real_T *) ssGetInputPortRealSignal(S, 2);
  const real_T *Mode = (real_T *) ssGetInputPortRealSignal(S, 3);
  const real_T *cartPos = (real_T *) ssGetInputPortRealSignal(S, 4);
  const real_T *Input = (real_T *) ssGetInputPortRealSignal(S, 5);
  real_T *EnableOut = (real_T *) ssGetOutputPortRealSignal(S, 0);
  real_T *Dir = (real_T *) ssGetOutputPortRealSignal(S, 1);
  real_T *PWMOut = (real_T *) ssGetOutputPortRealSignal(S, 2);
  sfcn_toPins_Outputs_wrapper(Enable, Analog, torqueOut, Mode, cartPos, Input,
    EnableOut, Dir, PWMOut);
}
