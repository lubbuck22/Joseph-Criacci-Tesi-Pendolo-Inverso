 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Thu Oct 24 18:34:59 2024
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                PotCalibration
...
/* Output Port  0 */
#define OUT_PORT_0_NAME                maxValue
...
/* Output Port  1 */
#define OUT_PORT_1_NAME                minValue
...
/* Output Port  2 */
#define OUT_PORT_2_NAME                initialValue
...
extern void PotCalibration_Outputs_wrapper(const real_T *Analog,
  const real_T *Save,
  real_T *maxValue,
  real_T *minValue,
  real_T *initialValue);
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port Analog of S-Function PotCalibration");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port Save of S-Function PotCalibration");
      return;
    }
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port maxValue of S-Function PotCalibration");
      return;
    }
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port minValue of S-Function PotCalibration");
      return;
    }
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port initialValue of S-Function PotCalibration");
      return;
    }
...
{
  const real_T *Analog = (real_T *) ssGetInputPortRealSignal(S, 0);
  const real_T *Save = (real_T *) ssGetInputPortRealSignal(S, 1);
  real_T *maxValue = (real_T *) ssGetOutputPortRealSignal(S, 0);
  real_T *minValue = (real_T *) ssGetOutputPortRealSignal(S, 1);
  real_T *initialValue = (real_T *) ssGetOutputPortRealSignal(S, 2);
  PotCalibration_Outputs_wrapper(Analog, Save, maxValue, minValue, initialValue);
}
